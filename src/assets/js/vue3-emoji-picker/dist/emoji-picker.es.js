...
import { reactive, readonly, defineComponent, inject, ref, computed, getCurrentInstance, watch, openBlock, createElementBlock, createElementVNode, normalizeClass, Fragment, renderList, toDisplayString, createCommentVNode, withDirectives, vModelText, onMounted, onBeforeUnmount, resolveComponent, createVNode, provide, createBlock } from "vue";
...
function Store() {
  const state = reactive({
    ...
    get groups() {
      ...
      return _groups.filter((group) => !disabled.includes(group.key));
    }
  });
...
const _sfc_main$4 = defineComponent({
  name: "Body",
  setup() {
    const { state, updateEmoji } = inject("store");
    const bodyInner = ref(null);
    const emojis2 = computed(() => filterEmojis(state.emojis, state.search, state.skinTone, state.options.disabledGroups));
    ...
    watch(() => state.activeGroup, () => {
      var _a, _b;
      (_b = (_a = bodyInner.value) == null ? void 0 : _a.querySelector("#" + state.activeGroup)) == null ? void 0 : _b.scrollIntoView({ behavior: "smooth" });
    });
    return {
      emojis: emojis2,
      bodyInner,
...
const _hoisted_6$3 = ["src", "alt", "onError"];
const _hoisted_7$3 = {
  key: 1,
  class: "v3-no-result"
};
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [
    createElementVNode("div", {
      ...
      Object.keys(_ctx.emojis).length ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(_ctx.emojis, (group, key) => {
        return openBlock(), createElementBlock("div", {
          ...
          createElementVNode("div", _hoisted_3$3, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(group, (emoji) => {
      ...
      }), 128)) : (openBlock(), createElementBlock("span", _hoisted_7$3, " No emoji has been found! "))
    ], 2)
  ]);
}
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.hasGroupIcons || _ctx.hasSearch ? (openBlock(), createElementBlock("div", _hoisted_1$2, [
    ...
    _ctx.hasGroupIcons && _ctx.hasSearch ? (openBlock(), createElementBlock("div", _hoisted_6$2)) : createCommentVNode("", true),
...
const _hoisted_6$1 = /* @__PURE__ */ createElementVNode("span", { class: "v3-icon" }, "\u{1F44D}", -1);
