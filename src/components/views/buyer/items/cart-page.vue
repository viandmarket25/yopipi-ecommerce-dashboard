      ...
      <div  style="width:1100px;  min-height:700px;  margin-top:2px; background:#ffffff; float:left; user-select:none; ">
        <div  style="width:100%;  height:90%; overflow-y:scroll;   background:#ffffff; float:left; user-select:none; ">
          ...
          <div style="width:100%;  height:auto;   background:#ffffff; float:left; user-select:none; ">
            <div  @click="goProductDetail('')" id="product-preview-details-containerid10l4pyy3med2bsschrb7o" class="featured-products-style-" data-product_id="416" style="width:100%; height:40px; cursor:pointer;  margin-bottom:20px; margin-left:0px;  margin-right:4px; float:left; ">
             ...
             <div id="product-avatar-container" class="" style=" width:100px; height:100px; overflow:hidden; float:left; ">
               <div id="product-title" class="" style=" height:auto; width:90%; margin-left:10px;  float:left;  border-radius:10px; font-size:12px; margin-top:10px; color:#404040; font-family:Montserrat-Bold;  ">
                SELECT
               </div>
             </div>
            ...
            <div v-for="(cartItem,index) in cartItems" :key="index"  @click="" id="product-preview-details-containerid10l4pyy3med2bsschrb7o" class="featured-products-style-" data-product_id="416" style="width:98%; height:140px; cursor:pointer; box-shadow:0px 0px 0px 1px #f1f1f1; background:#fafafa;  margin-bottom:10px; margin-left:1%;  margin-right:4px; float:left; ">

              <div id="product-details-container" class="product-details-container" align="left" style=" width:100%; height:40px; float:left; box-shadow:0px 0px 0px 1px #f1f1f1; position:relative; overflow:hidden; ">
              ...
              <div id="product-details-container" class="product-details-container" align="left" style=" width:100%; height:100px; float:left; position:relative; overflow:hidden; ">
                <div class="centered-position" id="product-avatar-container" style=" width:60px; height:100px; overflow:hidden; float:left; ">
                    <a-checkbox v-model:checked="cartItems[index].isChecked" @click="checkItem(index)" ></a-checkbox>
                </div>
               <div id="product-avatar-container" class="" style=" width:100px; height:100px; overflow:hidden; float:left; ">
               ...
               <div id="product-details-container" class="product-details-container" align="left" style=" width:16%; height:100px; float:left; position:relative; overflow:hidden; ">
                 <div id="product-title" class="" style=" height:auto; width:90%; margin-left:10px;  float:left; border-radius:10px; font-size:14px; margin-top:0px; color:#404040; font-family:Montserrat-Bold; font-size:11px; ">
                    <div id="product-preview-quantity-container0" class="product-preview-quantity-container">

                      <div id=""  style="width:120px; height:24px; float:left; box-shadow:0px 0px 0px 1px #f1f1f1; position:relative; padding-left:4px; margin-top:10px;  ">
                            <div  @click="decreaseQuantity(index)" id="decrease-button-holder-l4rfyyzs31i4cqeclr2" class="centered-position" style="width:20px; height:24px; float:left; margin-left:0px; position:relative; cursor:pointer;  ">
                             <img src="http://127.0.0.1/shorpi/assets/icons/decrease-product-icon.png" id="" class="" style="width:16px; height:16px; float:left;  position:relative; cursor:pointer; ">
                            </div>
                            <div id="" class="" style="width:64px; height:24px; float:left; position:relative; overflow:hidden; background:#f1f1f1; font-family:Montserrat-SemiBold; line-height:30px; font-size:13px; text-align:center; border:none;   ">
                              <input type="number" :placeholder="getQuantity(cartItems[index].quantity)" id="product-cart-item-quantityl4rfyyzs31i4cqeclr2" class="" style="width:30px; height:24px; float:right; position:relative; background:#ffffff; outline:none; font-family:Montserrat-SemiBold; font-size:13px; text-align:left; padding-left:6px; border:none;   ">
                            </div>
                            <div @click="increaseQuantity(index)" id="increase-button-holder-l4rfyyzs31i4cqeclr2" class="centered-position"  style="width:20px; height:24px; float:left; position:relative; cursor:pointer; margin-left:8px;">
                             <img src="http://127.0.0.1/shorpi/assets/icons/increase-product-icon.png" id="" class="" style="width:16px; height:16px; float:left; position:relative; cursor:pointer;  ">
                            </div>
                       </div>
                     </div>
               ...
               <div id="product-details-container" class="centered-position"  align="left" style=" width:16%; height:100px; float:left; position:relative; overflow:hidden; ">
                 ...
                 <div id="product-modify-button-container20" class="product-modify-button-container">
                   <img src="http://127.0.0.1/shorpi/assets/icons/modify-product-icon.png" id="product-modify-button-icon20" class="product-modify-button-icon">
                 </div>
                 <div id="product-delete-button-container10" class="product-delete-button-container">
                    <img src="http://127.0.0.1/shorpi/assets/icons/delete-icon-button.png" id="product-delete-button-icon10" class="product-delete-button-icon">
                 </div>
        ...
        <div class="centered-position" style="width:1100px;  height:10%; position:fixed; bottom:0vh;  box-shadow:0px 0px 3px 1px #f1f1f1; background:#ffffff; float:left; user-select:none; ">
          <div  style="width:86%;  height:100%;  box-shadow:0px 0px 3px 1px #f1f1f1; background:#ffffff; float:left; user-select:none; ">
            ...
            <div class="centered-position" style="width:20%;  height:100%; vertical-align:middle; box-shadow:0px 0px 3px 1px #f1f1f1; background:#ffffff; float:left; user-select:none; ">
              <div id="product-title" class="" style=" height:auto; width:90%; margin-left:10px;  float:left;  border-radius:10px; font-size:12px;  color:#404040; font-family:Montserrat-Bold;  ">
                Shipping: <span style="color:#888888; font-size:16px;">${{ getDecimalValue(shipping)}}</span>
              </div>
            </div>
            <div class="centered-position" style="width:20%;  height:100%; vertical-align:middle; box-shadow:0px 0px 3px 1px #f1f1f1; background:#ffffff; float:left; user-select:none; ">
              <div id="product-title" class="" style=" height:auto; width:90%; margin-left:10px;  float:left;  border-radius:10px; font-size:12px;  color:#404040; font-family:Montserrat-Bold;  ">
                Discounts: <span style="color:#888888; font-size:16px;">$ {{getDecimalValue(discounts)}} </span>
              </div>
            </div>
            <div class="centered-position" style="width:30%;  height:100%; vertical-align:middle; box-shadow:0px 0px 3px 1px #f1f1f1; background:#ffffff; float:left; user-select:none; ">
              <div id="product-title" class="" style=" height:auto; width:90%; margin-left:10px;  float:left;  border-radius:10px; font-size:12px;  color:#404040; font-family:Montserrat-Bold;  ">
                Total: <span style="color:#888888; font-size:16px;">${{ getDecimalValue(total)}}</span>
              </div>
            </div>
