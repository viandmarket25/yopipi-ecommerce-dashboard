<template>
  <div  class="centered-position" style="width:100vw; height:264px; display:flex; overflow:hidden; margin-top:20px; margin-bottom:20px; justify-items:center; float:left; user-select:none; ">
    <div @mouseleave="hoverCategoryView(0)"  style="min-width:1100px;  max-width:1100px;   box-shadow:0px 0px 0px 1px #f1f1f1;">


      <div style="width:100%; height:50px;  margin-top:0px; float:left; background:#fafafa; box-shadow:0px 0px 0px 1px #f1f1f1;  ">
        <div id="" class="" align="left" style="width:90%; max-height:300px; position:relative; margin-left:10px; font-size:13px; margin-bottom:10px; margin-top:10px; font-family:Montserrat-Bold; color:#000000; left:0px;">Recommended Products</div>
      </div>

      <div style="width:100%; height:200px;  margin-top:0px; float:left;  ">

        <div style="width:98%; height:200px; margin-left:0.4%; float:left;   ">
            <div v-for="(recommendedProduct,index) in recommendedProductList"  :key="index" @click="goProductDetail('')" id="product-preview-details-containerid10l4pyy3med2bsschrb7o" class="featured-products-style-" data-product_id="416" style="width:149px; height:200px; cursor:pointer;  background:#fafafa;  margin-top:2px; margin-left:3px;  margin-right:2px; float:left; ">
               <div id="product-avatar-container" class="" style=" width:100%; height:130px; overflow:hidden; float:left; ">
                  <img :src="getFlashDeal(recommendedProduct)" id="product-avatar" class="product-avatar-" style=" width:100%; height:150px; float:left; ">
               </div>
