<template>
    <div id="top-bar-container" class="top-bar-container" style="width:100%;  height:50px; user-select:none; padding-top:0px; box-shadow:0px 0px 0px 1px #f1f1f1; background:#fafafa; " align="center">
            <div align="left" style="width:400px; height:50px; font-size:30px; font-weight:bold; user-select:none; margin-left:10px; float:left; color:#ff7900; font-family:Poppins-Bold; text-decoration:none;  ">
                <router-link to="/app" >
