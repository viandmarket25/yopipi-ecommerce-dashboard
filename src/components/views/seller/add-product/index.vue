    ...
    <div style="width:100%; height:auto; overflow-y:hidden; margin-left:0%;  ">
      ...
      <div class="dashboard-content-block">
        <div class="dashboard-content-block-inner">
          ...
          <div align="left" style="height:87vh; margin-left:0px; overflow-y:scroll; ">
            <div align="left" style="height:auto; width:80%; padding-left:4%; margin-left:0px;  ">
...
import TopBarLoggedInWidget from './items/top-bar-add-product.vue';
...
export default {
  ...
  methods:{
    getDashboardIcons(name){
      let imgUrl;
      let page_ = window.location.href.split("add-product").join("");
    ...
    changeButtonProfileNavStyle(targetButton,activePage){
      ...
      if(key_!=prevKey_){
        ...
        previousButton.style.fontFamily="Montserrat-Medium"
        targetButton.style.fontFamily="Montserrat-SemiBold"
