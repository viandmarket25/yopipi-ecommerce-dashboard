  ...
  <div class="dashboard-background">
        <div style="width:100%; height:auto; overflow-y:hidden; margin-left:0%; user-select:none; ">
          <div class="dashboard-menu-block" >
             <div style="width:60%; height:90vh; float:left; position:relative; left:30px; margin-top:30px;    ">
          ...
          <div class="dashboard-content-block" >
            <div class="dashboard-content-block-inner">
              ...
              <div align="left" style="height:87vh;  overflow:hidden; ">
                <div style="width:100%; height:90vh;  overflow-y:hidden; box-shadow:0px 0px 0px 1px #f1f1f1; background:#fcfcfc;  padding-top:10px; padding-bottom:20px; ">
                <div style="width:27%; height:100%;  overflow-y:hidden; margin-left:1%; float:left;   ">
                  <div style="width:100%; height:100%;  overflow-y:scroll; margin-left:0%; float:left; background:#fcfcfc; ">
                    <div class="centered-position" style="width:100%; height:50px; float:left; border-radius:6px; ">
                      <div style="width:94%; height:34px; box-shadow:0px 0px 3px 1px #f1f1f1; background:#fafafa; float:left;  margin-left:0px; border-radius:6px; ">
                    ...
                    <div id="top-list-container" class="top-list-container" style="width:100%;  height:20px; text-align:left; position:relative;  color:#404040; font-family:Poppins-Medium; float:left; font-size:14px; " align="center">
                    </div>
                ...
                <div style="width:71.7%; height:100%;  overflow-y:hidden; margin-left:0.1%; float:left; box-shadow:0px 0px 0px 1px #f1f1f1; border-radius:10px; overflow-x:hidden;  background:#ffffff;   ">
                  ...
                  <div style="width:100%; height:8%; margin-left:0px; overflow-y:hidden; background:#fafafa; box-shadow:0px 0px 0px 1px #f1f1f1; padding-right:10px; padding-left:10px;  ">
                    <div class="centered-position" style="width:100%; height:100%; margin-left:0px; overflow-y:hidden; background:#fafafa; float:left;   ">
                  ...
                  <div style="width:100%; height:62%; margin-left:0px; overflow-y:scroll; padding-top:20px; padding-right:10px; padding-left:10px;  ">
