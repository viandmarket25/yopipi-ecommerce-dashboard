  ...
  <div class="dashboard-background">
    ...
    <div style="width:100%; height:auto; overflow-y:hidden; margin-left:0%;  ">
      ...
      <div class="dashboard-content-block">
        ...
        <div align="left" style="height:87vh; width:100%;  overflow-y:scroll; ">
          <div class="modern-shadow" style="width:400px; height:150px; float:left; ">
          </div>
...
import TopBarLoggedInWidget from './items/top-bar-shops.vue';
...
export default {
  ...
  methods:{
    getDashboardIcons(name){
      let imgUrl;
      let page_ = window.location.href.split("shops").join("");
